...
real_T look1_binlxpw_rd(real_T u0, const real_T bp0[], const real_T table[],
                     uint32_T maxIndex)
{
  real_T frac;
  real_T yL_0d0;
  ...
  arg_roll_rate_body, real_T arg_speed_magnitude, real_T &arg_aileron_deflection)
{
  ...
  arg_aileron_deflection = -(rtb_Sum1 * look1_binlxpw_rd(arg_speed_magnitude,
  ...
  roll_damper_controller_DW.DiscreteTimeIntegrator_DSTATE += look1_binlxpw_rd
